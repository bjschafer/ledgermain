 ...
 * rubric as fighter's pilot. Unlike fighter's pilot (66
 * archetypes, 378 features, which needed a heuristic-assisted pass for the
 ...
 *   Skirmisher's own ranger content is just Hunter's Tricks (5th level);
 *   Infiltrator's is just Adaptation (3rd level) — both classified above.
 *
