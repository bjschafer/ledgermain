 ...
 * bloodrager (ACG) is a spontaneous arcane caster too (own spell list, cha-
 * based); cleric/druid/paladin/ranger/warpriest/hunter are divine and never
 * incur ASF at all. (Note: magus and arcanist — also arcane — are not yet in
 * this set either; a pre-existing gap, not introduced here.)
 */
