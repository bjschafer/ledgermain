...
export interface CharacterDoc {
  ...
  build: {
     ...
     *
     * Grants the domain's *powers* (scaling off druid level, hand-authored
     * into `DruidDomain.features`/`.changes` — see that doc comment) AND one
     * domain spell slot per accessible druid spell level, drawable from
     ...
     * instance holds each pick). Back-compat: documents without this field
     * are unaffected.
     */
