...
import { characterExportFilename, characterExportJson } from "../src/model/exportCharacter.js";
...
describe("characterExportFilename", () => {
  it("slugifies the character name", () => {
    ...
    expect(characterExportFilename(doc)).toBe("thalia-stormrider.ledgermain.json");
  });
