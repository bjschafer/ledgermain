/**
 * Pure magus-arcana transitions. Arcana ids are just entries in
 ...
 * 9th,...) — i.e. `floor(magusLevel / 3)` arcana known at a given level (1 at
 * levels 3-5, 2 at levels 6-8, 3 at levels 9-11,...). Each copy of the "Extra
 * Arcana" feat (a stackable general feat) adds one more, counted by OCCURRENCE
 * in `doc.build.feats` (not just presence) — same "manually-added duplicates"
 * convention `expectedArcanistExploitCount` uses for "Extra Arcanist Exploit".
 *
