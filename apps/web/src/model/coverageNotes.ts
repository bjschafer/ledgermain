...
export const COVERAGE_NOTES: readonly CoverageNote[] = [
  ...
  },
  {
    ...
    note: 'Every published entry is browsable and searchable, and the five biggest lists — witch hexes, magus arcana, arcanist exploits, rogue talents, and alchemist discoveries — are fully written up with level requirements flagged. Entries that move numbers on your sheet automatically are marked with an "M" (and rogue talents that grant a specific feat apply it for you); everything else shows its rules text for you to apply at the table.',
    issueDetail:
      "Hand-table parity (issue #74 Phase 5): witch hexes 104, magus arcana 64, arcanist exploits 73, rogue talents 234, alchemist discoveries 168 — every vendored entry has a curated summary, soft minLevel gate, and context notes. Promotions that cleared the honesty bar: Iceplant hex (+2 NA), Stony Skin (DR 2/adamantine), 12 rogue-talent grantsFeat wires + Combat Trick's slot, and five discoveries (Awakened Intellect +2 Int, Chameleon Stealth +4/+8, Pheromones +3 competence social skills, Webbed Extremities Swim +4, Mummification cold/paralysis/sleep immunities). The remaining lists (ki powers, style strikes, tricks, bold stares, amplifications, ninja tricks, vigilante talents, slayer/investigator talents) are core-modeled with vendored-prose fallback rows.",
  },
  {
