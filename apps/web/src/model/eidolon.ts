 ...
 * `companionFeatPrereqContext`, including the empty `casterKinds` (no
 * eidolon casts, so an "ability to cast X spells" prereq is never met via
 * the eidolon's own casting).
 */
