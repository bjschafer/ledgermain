...
async function fetchAll(): Promise<RefData> {
  ...
  const [
    ...
    getJson<RefData["itemAbilities"]>("item-abilities.json"),
    ...
    getJson<RefData["druidDomainSpellLists"]>("druid-domain-spell-lists.json"),
    getJson<RefData["elementalSchoolSpellLists"]>("elemental-school-spell-lists.json"),
    getJson<RefData["wizardSchools"]>("wizard-schools.json"),
    getJson<RefData["focusedSchools"]>("focused-schools.json"),
    ...
    getJson<RefData["sorcererBloodlineMutations"]>("sorcerer-bloodline-mutations.json"),
