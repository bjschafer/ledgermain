			...
			{!collapsed && (
				<>
					...
					<div className="ranger-block">
						...
						<p className="hint">
							The chosen style's bonus feats can be taken without meeting their
							normal prerequisites (they show as "combat style" in the feat list).
							The bonus-feat count is already applied automatically.
						</p>
					</div>
