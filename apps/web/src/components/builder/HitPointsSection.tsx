      ...
      {mode === "rolled" ? (
        <>
          <p className="hint" style={{ marginBottom: 8 }}>
            Enter your rolls per character level. Level 1 is always maxed (PF1 standard).
          </p>
          {charLevel === 0 ? (
            ...
            <div className="hp-rolls-list">
              {levelRows.map(({ charLv, die, isFirst }) => {
                ...
                const displayVal = isFirst ? die : (stored ?? Math.floor(die / 2) + 1);
                return (
                    ...
                    {isFirst ? (
                      ...
                      <>
                        ...
                        <NumberField
                          ...
                          min={1}
                          max={die}
                          onCommit={(n) => update((d) => setHpRoll(d, charLv, n))}
          ...
          <div style={{ marginTop: 12 }}>
            ...
            {auto !== sheet.hp.max && <span className="hint"> · average would be {auto}</span>}
          </div>
        </>
      ) : (
        ...
        <div className="hp-override-row">
          <label className="hp-override-label" htmlFor="hp-override-input">
            ...
            {hasOverride ? (
              ...
              <span className="hp-override-badge hp-override-badge--auto">using {mode}</span>
            )}
          </label>
          <NumberField
            className="num"
