...
**Fighter re-classification after the weapon-group fix:** see `archetype-extracted/fighter.ts`'s header for the promoted-feature count and methodology; this section will be updated with the final tally once that pass is complete.
